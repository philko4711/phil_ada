...
package body gll_pkg is
   function init(init_val: in ITEM) return list_elm_ptr is
      root: list_elm_ptr;
   begin
      root := new list_elm;
   ...
   procedure push_back(root: out list_elm_ptr; val: in ITEM) is
   ...
   procedure push_front(root: out list_elm_ptr; val: in ITEM) is
   ...
   procedure insert(root: out list_elm_ptr; val: in ITEM) is
      ptr: list_elm_ptr := root;
